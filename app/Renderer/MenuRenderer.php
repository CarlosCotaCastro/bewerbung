...
class MenuRenderer {
	...
	public function Render() {
		return
            '<div class="menu">'
            . '<div class="wrapper">'
                . '<a href="/" class="logo col-xl-2 col-l-2 col-m-4 col-s-6">'
                    . $this->RenderLogo()
                . '</a>'
                . '<ul class="menu_items">'
                    . $this->RenderItems()
    ...
    private function RenderItem(stdClass $item) {
        return
            '<li>'
